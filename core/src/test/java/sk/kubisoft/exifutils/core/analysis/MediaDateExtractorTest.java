...
class MediaDateExtractorTest {
    ...
    void noDateFoundForImage1() {
        ...
        Optional<MediaDateTime> creationDate = mediaDateExtractor.extractDate(metaData);
    ...
    void extractCreationDateForVideo4() {
        ...
        assertTrue(creationDate.isPresent());
        assertEquals("2023-04-19T16:43:21", creationDate.get().getLocalDateTime().toString());
        assertFalse(creationDate.get().hasZoneOffset());
    }
    ...
    void extractCreationDateForVideo5() {
        ...
        assertTrue(creationDate.isPresent());
        assertEquals("2024-08-10T15:52:18", creationDate.get().getLocalDateTime().toString());
        assertFalse(creationDate.get().hasZoneOffset());
    }
    ...
    void extractCreationDateForVideo6() {
        ...
        assertTrue(creationDate.isPresent());
        assertEquals("2025-01-04T15:58:01", creationDate.get().getLocalDateTime().toString());
        assertFalse(creationDate.get().hasZoneOffset());
    }
